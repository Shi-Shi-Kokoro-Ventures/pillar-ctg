          ...
          {isSubmitted ? (
            ...
            <ApplicationWrapper>
              <ApplicationHeader 
                ...
                icon={<Home className="h-8 w-8 text-redcross" />}
              />
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                      ...
                      <div className="space-y-2">
                        ...
                        {form.watch("hasOtherIncome") && (
                          <Textarea
                            ...
                            placeholder="Please describe other income sources"
                            className="mt-2 bg-form-bg border-form-border focus:border-form-focus"
                          />
                        )}
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        {form.watch("isUnemployed") && (
                          <Textarea
                            ...
                            placeholder="How long unemployed and circumstances"
                            className="mt-2 bg-form-bg border-form-border focus:border-form-focus"
                          />
                        )}
                      </div>
                  ...
                  <div className="p-6 bg-white rounded-xl shadow-md border border-gray-100 neo-glass-card">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {assistanceTypeOptions.map((option) => (
                          <div key={option.id} className="flex items-center space-x-2">
                            <Checkbox
                              id={`assistanceType-${option.id}`}
                              checked={form.watch("assistanceType")?.includes(option.id)}
                              onCheckedChange={(checked) => {
                                const current = form.getValues("assistanceType") || [];
                                if (checked) {
                                  form.setValue("assistanceType", [...current, option.id], { shouldValidate: true });
                                } else {
                                  form.setValue("assistanceType", current.filter(value => value !== option.id), { shouldValidate: true });
                                }
                              }}
                              className="data-[state=checked]:bg-redcross data-[state=checked]:border-redcross"
                            />
                            <Label htmlFor={`assistanceType-${option.id}`} className="font-normal">
                              {option.label}
                            </Label>
                          </div>
                        ))}
                      ...
                      {form.formState.errors.assistanceType && (
                        <p className="text-red-500 text-sm">{form.formState.errors.assistanceType.message}</p>
                      )}
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                      <div className="space-y-2">
                        <Label htmlFor="amountNeeded" className="text-form-label flex items-center gap-1">
                          Amount of Assistance Needed <span className="text-red-500">*</span>
                        </Label>
                        <div className="relative">
                          <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">$</span>
                          <Input
                    ...
                    <div className="mt-6 space-y-2">
                      ...
                      <Textarea
                        ...
                        placeholder="Please explain why you're seeking assistance"
                  ...
                  <div className="p-6 bg-white rounded-xl shadow-md border border-gray-100 neo-glass-card">
                    <h2 className="text-xl font-semibold mb-6 pb-2 border-b flex items-center gap-2 text-gradient-primary">
                      <BookOpen className="h-5 w-5 text-redcross" />
                      Additional Information
                    </h2>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="hasPriorAssistance" className="font-normal">
                          I have received housing assistance in the past
                        </Label>
                      </div>
                      ...
                      {form.watch("hasPriorAssistance") && (
                        <div className="space-y-2">
                          ...
                          <Textarea
                            ...
                            placeholder="Please describe when and what type of assistance you received"
                            className="bg-form-bg border-form-border focus:border-form-focus"
                          />
                        </div>
                      )}
                      ...
                      <div className="space-y-2 mt-4">
                        ...
                        <Textarea
                          ...
                          placeholder="Any other information that would help us understand your situation"
                          className="bg-form-bg border-form-border focus:border-form-focus"
                          rows={4}
                        />
                      </div>
                      ...
                      <div className="mt-4 flex items-center space-x-2">
                        <Checkbox
                          ...
                          className="data-[state=checked]:bg-redcross data-[state=checked]:border-redcross"
                        />
                        <Label htmlFor="hasDocuments" className="font-normal flex items-center gap-1">
                          <FileImage className="h-4 w-4 text-gray-600" />
                          I have supporting documents (pay stubs, lease, bills, etc.)
                        </Label>
                      </div>
                      
                      {form.watch("hasDocuments") && (
                        <p className="text-sm text-gray-500 mt-2">
                          You'll be contacted to provide these documents after submitting your application.
                        </p>
                      )}
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        <div className="flex items-start space-x-2">
                          ...
                          />
                          <Label htmlFor="consentToVerification" className="font-normal text-sm leading-tight">
                            I consent to the verification of the information provided in this application, including
                            contacting landlords, employers, and other relevant parties to verify my eligibility for
                            assistance. <span className="text-red-500">*</span>
                          </Label>
                        </div>
                        {form.formState.errors.consentToVerification && (
                          <p className="text-red-500 text-sm">{form.formState.errors.consentToVerification.message}</p>
                        )}
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-start space-x-2">
                          <Checkbox
                            ...
                            className="data-[state=checked]:bg-redcross data-[state=checked]:border-redcross mt-1"
                          />
                          <Label htmlFor="agreeToTerms" className="font-normal text-sm leading-tight">
                            I agree to the terms and conditions for housing assistance, including any requirements for
                            ongoing eligibility and participation in any required programs or services. <span className="text-red-500">*</span>
                          </Label>
                        </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-start space-x-2">
                          <Checkbox
                            ...
                            className="data-[state=checked]:bg-redcross data-[state=checked]:border-redcross mt-1"
                          />
                          <Label htmlFor="certifyTruthfulness" className="font-normal text-sm leading-tight">
                            I certify that all information provided in this application is true and complete to the
                            best of my knowledge. I understand that providing false information may result in denial
                            of assistance and may be subject to legal action. <span className="text-red-500">*</span>
                          </Label>
                        </div>
                        {form.formState.errors.certifyTruthfulness && (
                          <p className="text-red-500 text-sm">{form.formState.errors.certifyTruthfulness.message}</p>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-center pt-6">
                    <Button 
                      type="submit" 
                      className="w-full md:w-auto min-w-[200px] bg-gradient-to-r from-redcross to-redcross-dark text-white px-8 py-6 hover:opacity-90 transition-opacity font-medium text-lg relative overflow-hidden button-border-light"
