            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8 mt-12">
                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-redcross">
                  <div className="flex items-start">
                    <div className="bg-redcross/10 w-12 h-12 rounded-full flex items-center justify-center mr-4">
                      <Shield className="h-6 w-6 text-redcross" />
                    </div>
                    <div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-redcross">
                  <div className="flex items-start">
                    <div className="bg-redcross/10 w-12 h-12 rounded-full flex items-center justify-center mr-4">
                      <Scale className="h-6 w-6 text-redcross" />
                    </div>
                    <div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-redcross">
                  <div className="flex items-start">
                    <div className="bg-redcross/10 w-12 h-12 rounded-full flex items-center justify-center mr-4">
                      <FileText className="h-6 w-6 text-redcross" />
                    </div>
                    <div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/community-resources">
                <Button variant="outline" className="border-white text-white hover:bg-redcross-dark">
